...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || "ᴏxᴢᴢʏ-ʙᴏᴛ",
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY VISHNU😆*",
...
ᴋᴇᴇᴘ ᴜsɪɴɢ ✦ᴏxᴢᴢʏ-ʙᴏᴛ✦ ғʀᴏᴍ ᴠɪꜱʜɴᴜ ɪɴᴄ⚡
...
> ɢɪᴛʜᴜʙ : github.com/oxzzyofc/OXZZY-BOT`,
    ...
    STICKER_NAME: process.env.STICKER_NAME || "ᴏxᴢᴢʏ-ʙᴏᴛ",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "7907389440",
    // add your bot owner number

    OWNER_NAME: process.env.OWNER_NAME || "ᴏxᴢᴢʏ-ʙᴏᴛ",
    // add bot owner name

    DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴠɪꜱʜɴᴜ*",
    ...
    DEV: process.env.DEV || "7907389440",
...
*ᴋᴇᴇᴘ ᴏɴ ᴜsɪɴɢ ᴏxᴢᴢʏ-ʙᴏᴛ🚩* 

> sᴜʙsᴄʀɪʙᴇ ʏᴛ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴛᴜᴛᴏʀɪᴀʟs
https://youtube.com/@ox_zzy
